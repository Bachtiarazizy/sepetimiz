  ...
  return (
    <section
      className="py-12 sm:py-16 bg-primary text-primary-foreground backdrop-blur-sm backdrop-saturate-150 border border-white/10
                  shadow-lg cursor-pointer dark:bg-gradient-to-tr dark:from-slate-500/20 dark:border-white/10 dark:bg-transparent"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-4 text-primary-foreground/80 dark:text-primary">Start Selling Your Products Today</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <School className="w-6 h-6 shrink-0 mt-1 text-primary-foreground/80 dark:text-primary" />
                <div>
                  <h3 className="font-semibold text-primary-foreground/80 dark:text-primary">Student-Friendly Platform</h3>
                  <p className="text-primary-foreground/80 dark:text-primary text-sm">Easy to use alongside your studies</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Users className="w-6 h-6 shrink-0 mt-1 text-primary-foreground/80 dark:text-primary" />
                <div>
                  <h3 className="font-semibold text-primary-foreground/80 dark:text-primary">Growing Community</h3>
                  <p className="text-primary-foreground/80 dark:text-primary text-sm">Connect with Indonesian students across Turkiye</p>
                </div>
              </div>
            </div>
            <Link href="/sign-up">
