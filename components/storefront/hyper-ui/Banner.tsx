      ...
      <div className="relative h-full w-full max-w-5xl px-8 sm:px-8 md:px-20 lg:px-32 items-center justify-center pt-24 pb-32 z-20">
        ...
        <BoxReveal boxColor={"#5046e6"} duration={0.5}>
          <div className="mt-6 flex gap-5">
            <a className="group relative inline-flex items-center overflow-hidden rounded-full bg-foreground px-8 py-3 text-white dark:text-zinc-950 focus:outline-none focus:ring active:bg-indigo-500" href="dashboard/shops">
