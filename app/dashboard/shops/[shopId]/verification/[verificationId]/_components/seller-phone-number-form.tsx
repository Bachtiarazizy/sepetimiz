...
interface SellerPhoneNumberFormProps {
  initialData: {
    phoneNumber: string;
  };
  shopId: string;
...
export default function SellerPhoneNumberForm({ initialData, shopId, verificationId }: SellerPhoneNumberFormProps) {
  ...
  return (
    <div className="mt-6 border bg-slate-100 dark:bg-slate-900 rounded-md p-4">
      ...
      {!isEditing && <p className="text-sm mt-2">{initialData.phoneNumber}</p>}
      {isEditing && (
        <Form {...form}>
