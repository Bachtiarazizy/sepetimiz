...
const Footer = () => {
  return (
    <footer className="fw-full border-t">
      <div className="mx-auto px-4 pb-6 pt-16 sm:px-6 lg:px-10 lg:pt-16">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div className="gap-6">
            ...
            <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <Link href="https://www.instagram.com/libi.ppit/?hl=tr" rel="noreferrer" target="_blank" className="transition-colors hover:text-primary">
              ...
              <li>
                <Link href="https://www.instagram.com/libi.ppit/?hl=tr" rel="noreferrer" target="_blank" className="transition hover:text-primary">
