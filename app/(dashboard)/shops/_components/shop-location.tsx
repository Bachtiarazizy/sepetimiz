...
export default function ShopLocationForm({ initialData, shopId }: ShopLocationFormProps) {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Shop's location</FormLabel>
                  <FormControl>
                    <Input disabled={isSubmitting} placeholder="Enter shop" {...field} />
                  </FormControl>
                  <FormDescription>Enter location of your shop</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
